"""Practice Task 5: A 3-row, 1-column subplot figure showing a line plot, a
bar plot and a scatter plot of related data, sharing a common x-axis.

Data: monthly temperature, rainfall and umbrella sales for one city.
"""
...
temperature = [18, 20, 25, 30, 34, 33, 31, 30, 29, 26, 21, 18]  # deg C
rainfall = [12, 9, 11, 20, 55, 180, 240, 210, 150, 60, 15, 10]  # mm
umbrella_sales = [50, 40, 45, 70, 150, 400, 520, 480, 350, 160, 55, 45]  # units
...
# Row 1: line plot of temperature
...
# Row 3: scatter plot of umbrella sales
